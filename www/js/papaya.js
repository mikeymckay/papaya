...
var Papaya, RecordAudio, Router, clickortouch, defaultLanguages, directoryPath, router, serverPath, _ref,
  ...
  Papaya.initializePhonegapFiles = function() {
    ...
    window.plugins.asset2sd.startActivity({
      ...
      return Papaya.loadConfig({
        ...
        success: function() {
          var data, language, phoneme, voice, _ref, _results;
                ...
                _results1.push((function() {
                  ...
                  for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
                    ...
                    _results2.push(window.plugins.asset2sd.startActivity({
                      ...
                      return console.log("Copied www/" + language + "/" + voice + "_" + phoneme + ".mp3");
                    }, function() {
                      return console.log("ERROR: Could no copy www/" + language + "/" + voice + "_" + phoneme + ".mp3");
                    }));
                  }
                  return _results2;
                })());
    ...
    return this.downloadLanguageJson(defaultLanguages, function(result) {
